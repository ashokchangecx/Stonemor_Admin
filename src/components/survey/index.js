    ...
    <div>
      ...
      <div>
        ...
        <Fab
          ...
          component={Link}
          to={
            getSurvey.mainQuestionnaire
              ? `/addentry/${getSurvey.mainQuestionnaire.id}`
              : "/"
          }
        >
          <AddIcon />
...
const Survey = compose(
  ...
  graphql(gql(listSurveyEntriess), {
    ...
    props: (props) => {
      return {
        listSurveyEntriess: props.data.listSurveyEntriess
          ? props.data.listSurveyEntriess
          : [],
